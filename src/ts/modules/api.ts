import { ICreatedCar, IWinner, IUpdatedWinner } from './interfaces';
...
export const getWinners = async (page: number, limit = 10, sort = 'id', order = 'ASC') => {
...
export const updateWinner = async (id: number, body: IUpdatedWinner) => {
  const response = await fetch(`${winners}/${id}`, {
    method: 'PUT',
    body: JSON.stringify(body),
    headers: {
